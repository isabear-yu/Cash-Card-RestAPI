...
//@DirtiesContext(classMode = ClassMode.AFTER_EACH_TEST_METHOD) //@DirtiesContext cause Spring to start with a clean slate, as if those other tests hadn't been run.
class CashCardApplicationTests {

    //asked Spring to inject a test helper that’ll allow us to make HTTP requests to the locally running application
    @Autowired
    ...
    void shouldReturnACashCardWhenDataIsSaved() {
        /**
         * restTemplate will return a ResponseEntity, which we've captured
         * in a variable we've named response. ResponseEntity is another helpful
         * Spring object that provides valuable information about what happened with our request.
         */
        ...
        //inspect many aspects of the response, including the HTTP Response Status code, which we expect to be 200 OK.
    ...
    void shouldCreateANewCashCard() {
        ...
        //when a POST request results in the successful creation of a resource, such as a new CashCard, the response should include information for how to retrieve that resource.
    ...
    void shouldUpdateAnExistingCashCard() {
        ...
        /** putForEntity() doesn't exist
         *  call exchange(), which sends a PUT request for the target ID of 99 and updated Cash Card data
         * */
        ...
        /** fetch CashCard 99 again, so we can verify that it was updated.*/
